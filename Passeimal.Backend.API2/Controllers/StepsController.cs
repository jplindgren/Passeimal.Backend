...
namespace Passeimal.Backend.API2.Controllers{
    ...
    public class StepsController : ApiController {
        ...
        public HttpResponseMessage Get() {
            ...
            //clock.Start();
            var stepsBatch = _stepQuery.GetAll();
            //clock.Stop();
            //Trace.WriteLine("Tempo Dapper: " + clock.ElapsedMilliseconds);
            ...
            //clock.Stop();
            //Trace.WriteLine("Tempo EF: " + clock.ElapsedMilliseconds);
